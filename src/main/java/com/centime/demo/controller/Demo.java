...
import com.centime.demo.util.ResponseUtil;
...
public class Demo extends BaseController {
  ...
  public ResponseEntity<Response<String>> returnRequestString(@RequestBody String sampleInput,
      @RequestHeader(value = EndpointConstants.CLIENT_ID) Integer clientId,
      @RequestHeader(value = EndpointConstants.LOGIN_ID) String loginId)
